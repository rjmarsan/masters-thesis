...
%TODO:
% Add GPStore images
% Put GPSTORE reference in background
% put GPStore permission image in permissions
% put in footnote about Android 4.2 READ_STORAGE
% Expand on permission rejection in Permissions
% Find official source for improving rootkit protection, cite that later.
% Show some examples of SMS Trojan - FakeInst
% Put in paragraph about our own malware dataset
% Make related works go Project, Shortcomings, Project SHortcomings, etc.
% Cite all security extensions in Architecture
% Make goals of architecture a bullet list
% Include companion app in architecutre overview figure
% Talk more about market dataset.
% Include appendix of all permissions - just copypaste the spreadsheet, and reference it when we start talking about permissions
% Further talk about outliers in the GPStore thingie that personalization
...
% Reference the GPStore image in the marketanalysis when talking about popular apps
% Generate table of malware dataset and target SDKs, and use to talk about why it's useless.
